...
public class Settings : Form
{
  ...
  public bool Restart;
  private List<Rectangle> ColorRects = [];
  private List<Rectangle> PensRects = [];
  private List<Paint.Paint.MyRectangle> PensObj = [];
  private List<Paint.Paint.MyRectangle> ColorObj = [];
  ...
  private void CreateColors()
  {
    ...
    {
      var rectangle = new Rectangle(215, 80 + 40 * index, 40, 20);
      ColorRects.Add(rectangle);
      var colorObj = ColorObj;
      var myRectangle = new Paint.Paint.MyRectangle();
      myRectangle.Bounds = rectangle;
      myRectangle.Text = string.Empty;
  ...
  private void CreatePens()
  {
    ...
    for (var index = 0; index < 4; ++index)
    {
      var rectangle = new Rectangle(285, 80 + 40 * index, 40, 20);
  ...
  {
    foreach (var figure in ColorObj)
    {
      figure.DrawFigure(e.Graphics);
    }

    foreach (var figure in PensObj)
    {
      figure.DrawFigure(e.Graphics);
    }
  }
  ...
  protected override void OnMouseDown(MouseEventArgs e)
  {
    ...
    foreach (var pensRect in PensRects)
    {
  ...
  private void InitializeComponent()
  {
    ...
    numericUpDown1.Maximum = new Decimal([
      4,
      0,
      0,
      0,
    ]);
    numericUpDown1.Minimum = new Decimal([
      2,
      0,
      0,
      0,
